...
class m191018_145937_sys_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%sys_menu}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统_菜单导航表'");
        ...
        $this->insert('{{%sys_menu}}',['id'=>'49','title'=>'面积管理','cate_id'=>'1','pid'=>'0','url'=>'/area/index','icon'=>'fa fa-align-justify','level'=>'1','dev'=>'0','sort'=>'0','params'=>'[{"key": "", "value": ""}]','status'=>'1','tree'=>'tr_0 ','created_at'=>'1571334212','updated_at'=>'1571405728']);
        $this->insert('{{%sys_menu}}',['id'=>'50','title'=>'分类管理','cate_id'=>'1','pid'=>'0','url'=>'/category/index','icon'=>'fa fa-align-justify','level'=>'1','dev'=>'0','sort'=>'0','params'=>'[{"key": "", "value": ""}]','status'=>'1','tree'=>'tr_0 ','created_at'=>'1571335089','updated_at'=>'1571335089']);
        $this->insert('{{%sys_menu}}',['id'=>'51','title'=>'城市管理','cate_id'=>'1','pid'=>'0','url'=>'/city/index','icon'=>'fa fa-align-justify','level'=>'1','dev'=>'0','sort'=>'0','params'=>'[{"key": "", "value": ""}]','status'=>'1','tree'=>'tr_0 ','created_at'=>'1571405752','updated_at'=>'1571405765']);
        $this->insert('{{%sys_menu}}',['id'=>'52','title'=>'项目管理','cate_id'=>'1','pid'=>'0','url'=>'/project/index','icon'=>'fa fa-align-justify','level'=>'1','dev'=>'0','sort'=>'0','params'=>'[{"key": "", "value": ""}]','status'=>'1','tree'=>'tr_0 ','created_at'=>'1571405786','updated_at'=>'1571405891']);
        $this->insert('{{%sys_menu}}',['id'=>'53','title'=>'设施管理','cate_id'=>'1','pid'=>'0','url'=>'/facility/index','icon'=>'fa fa-align-justify','level'=>'1','dev'=>'0','sort'=>'0','params'=>'[{"key": "", "value": ""}]','status'=>'1','tree'=>'tr_0 ','created_at'=>'1571405885','updated_at'=>'1571405885']);
